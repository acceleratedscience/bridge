    ...
    fn call(&self, req: ServiceRequest) -> Self::Future {
        ...
        Box::pin(async move {
            ...
            res.headers_mut().insert(
                ...
                HeaderValue::from_str("default-src 'self'; img-src * data:; style-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css; script-src * 'unsafe-inline' 'unsafe-eval';")?,
            );
            Ok(res)
        })
    }
