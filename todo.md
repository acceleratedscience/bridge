...
-   [ ] **User management > User:** Delete user not working
...
-   [x] **Workbench:** I can't open or terminate anymore, so I can't check if the UI was completed
-   [x] **Just command:** I can't run build-front because of uglifyjs ... – I was able to make it work by prepending npx, but you requested not to add that, how then?
...
-   [x] **User database:** created_at and updated_at are stored as array instead of data, is that on purpose?
