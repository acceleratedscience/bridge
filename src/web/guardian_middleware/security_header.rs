    ...
    fn call(&self, req: ServiceRequest) -> Self::Future {
        ...
        Box::pin(async move {
            ...
            res.headers_mut().insert(
             ...
             HeaderValue::from_str("default-src 'self'; font-src 1.www.s81c.com; img-src * data:; style-src 'self' 'unsafe-inline' https://1.www.s81c.com; script-src 'self' 'nonce-login-redirect-guardian' 'nonce-guardian-group-form-val' https://unpkg.com https://1.www.s81c.com;")?,
            );
            Ok(res)
        })
    }
